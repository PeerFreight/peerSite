...
export default function CarriersPage() {
  return (
    <>
      ...
      <main id="main">
        <section className="hero" aria-labelledby="carrier-title">
          ...
          <div className="wrap">
            ...
            <div className="perks mosaic">
              <article className="perk">
                <div className="perk__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 2v20"/><path d="M17 6.5c0-2-2.2-3-5-3s-5 1-5 3.2c0 4.8 10 2.8 10 7.6 0 2.2-2.2 3.2-5 3.2s-5-1.2-5-3.2"/></svg></div>
                <h3>Fast pay</h3>
                <p>24 to 48 hours standard, same day when you need it. Skip your factor&apos;s fee.</p>
              </article>
              <article className="perk">
                <div className="perk__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h10"/><path d="m17 16 2 2 3-3"/></svg></div>
                <h3>Accessorials honored</h3>
                <p>Detention, layover, and TONU, in writing on the rate confirmation.</p>
              </article>
              <article className="perk">
                <div className="perk__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg></div>
                <h3>Accurate loads</h3>
                <p>Real weights and real appointment times.</p>
              </article>
              <article className="perk">
                <div className="perk__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M8 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3"/><path d="M17 3l4 4-9 9H8v-4Z"/></svg></div>
                <h3>Easy paperwork</h3>
                <p>Upload your POD from your phone. No endless check calls.</p>
              </article>
              <article className="perk">
                <div className="perk__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 3 5 6v5c0 4.5 3 7.5 7 9 4-1.5 7-4.5 7-9V6l-7-3Z"/><path d="m9 12 2 2 4-4"/></svg></div>
                <h3>A broker that does not ghost</h3>
                <p>Active authority, bonded, and we pay on time.</p>
              </article>
              <article className="perk">
                <div className="perk__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 3 2 20h20L12 3Z"/><path d="M12 10v4"/><path d="M12 17h.01"/></svg></div>
