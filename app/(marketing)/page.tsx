  ...
  return (
    <>
      ...
      <main id="main">
        ...
        {/* WHO WE SERVE */}
        <section className="section section--photo" id="freight" aria-labelledby="serve-title">
          <img className="section--photo__bg" src="/site/freight-hero-terminal-morning.jpg" alt="" loading="lazy" />
          <div className="wrap">
            ...
            <div className="gcards">
              ...
              <article className="gcard glass">
                <div className="gcard__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><line x1="2" x2="22" y1="12" y2="12"/><line x1="12" x2="12" y1="2" y2="22"/><path d="m20 16-4-4 4-4"/><path d="m4 8 4 4-4 4"/><path d="m16 4-4 4-4-4"/><path d="m8 20 4-4 4 4"/></svg></div>
                <h3>Reefer and dry van</h3>
                <p>Temperature controlled and standard truckload, delivered on time.</p>
              </article>
              <article className="gcard glass">
                <div className="gcard__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M2 8h12v8H2z"/><path d="M14 11h4l3 3v2h-7z"/><circle cx="6.5" cy="17.5" r="1.7"/><circle cx="17" cy="17.5" r="1.7"/></svg></div>
                <h3>Flatbed and specialized</h3>
                <p>Machinery, building materials, and oversize loads.</p>
              </article>
              <article className="gcard glass">
                <div className="gcard__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M2 20h20"/><path d="M4 20V9h6v11"/><path d="M14 20V4h6v16"/><path d="M6 12h2"/><path d="M6 15h2"/><path d="M16 8h2"/><path d="M16 12h2"/></svg></div>
                <h3>Port drayage</h3>
        ...
        {/* HOW WE RUN A LOAD (all four steps visible, nothing to click) */}
        <section className="section section--navy" aria-labelledby="svc-title">
          <div className="wrap">
            <div className="section__head on-dark">
            ...
            <div className="svc-grid">
              <article className="svc-card">
                ...
                <hr className="svc-card__rule" />
                <div className="svc-card__stat"><b>Real</b><span>market comps behind every rate</span></div>
                <p className="svc-card__desc">Every quote comes with the current spot and contract comps for your lane. If the market moves between quotes, you see the new data, and the invoice always matches the rate you approved.</p>
              </article>
              <article className="svc-card">
                <div className="svc-card__head">
                ...
                <hr className="svc-card__rule" />
                <div className="svc-card__stat"><b>100%</b><span>of carriers verified before dispatch</span></div>
                <p className="svc-card__desc">We recheck identity, authority, insurance, and safety history on every load, not only once at signup, because that is where fraud slips in. If anything looks off, the load goes to a different truck.</p>
              </article>
              <article className="svc-card">
                <div className="svc-card__head">
                ...
                <hr className="svc-card__rule" />
                <div className="svc-card__stat"><b>24/7</b><span>owner access on every load</span></div>
                <p className="svc-card__desc">We surface problems early, while there is still time to fix them. If something goes sideways at 2 a.m., you reach one of the owners on the phone, not a call center.</p>
              </article>
              <article className="svc-card">
                <div className="svc-card__head">
                ...
                <hr className="svc-card__rule" />
                <div className="svc-card__stat"><b>Same day</b><span>signed proof of delivery</span></div>
                <p className="svc-card__desc">The signed proof of delivery lands in your inbox the day the load delivers, so your own billing never waits on us. Accessorials are spelled out in writing, with no surprise charges weeks later.</p>
              </article>
            </div>
          </div>
        </section>
        ...
        {/* HOW IT WORKS */}
        <section className="section section--photo" id="how" aria-labelledby="how-title">
          <img className="section--photo__bg" src="/site/freight-dock-dusk.jpg" alt="" loading="lazy" />
          <div className="wrap">
            <div className="split">
              <div className="split__copy">
                ...
                <ol className="steplist">
                  <li className="steplist__row">
                    <span className="steplist__num" aria-hidden="true">01</span>
                    <div>
                  ...
                  <li className="steplist__row">
                    <span className="steplist__num" aria-hidden="true">02</span>
                    <div>
                      <h3>Get your rate</h3>
                  ...
                  <li className="steplist__row">
                    <span className="steplist__num" aria-hidden="true">03</span>
                    <div>
                  ...
                  <li className="steplist__row">
                    <span className="steplist__num" aria-hidden="true">04</span>
                    <div>
              ...
              <div className="split__panel glass" aria-hidden="true">
        ...
        {/* WHY PEER */}
        <section className="section section--photo section--photo--rev" aria-labelledby="why-title">
          <img className="section--photo__bg" src="/site/freight-yard-aerial-night.jpg" alt="" loading="lazy" />
          <div className="wrap">
            <div className="section__head on-dark">
              ...
              <div className="split__copy">
                <div className="why-tiles">
                  <div className="why-tile">
                    <span className="why-tile__label">Owner access</span>
                    <span className="why-tile__stat">24/7</span>
                    <span className="why-tile__desc">Reach an owner directly on any load, at any hour.</span>
                  </div>
                  <div className="why-tile">
                    <span className="why-tile__label">Carrier pay</span>
                    <span className="why-tile__stat">24-48h</span>
                    <span className="why-tile__desc">Fast pay is why the best trucks take our loads first.</span>
                  </div>
                  <div className="why-tile">
                    <div className="why-tile__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="9" r="6"/><path d="m8.5 13.5-1.5 7 5-3 5 3-1.5-7"/></svg></div>
                    <span className="why-tile__label">TIA member</span>
                    <span className="why-tile__desc">Held to the Transportation Intermediaries Association anti-fraud standard.</span>
                  </div>
                  <div className="why-tile">
                    <div className="why-tile__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v1.5"/><path d="M3.5 12a8.5 8.5 0 0 1 17 0Z"/><path d="M12 12v6a2.5 2.5 0 0 0 5 0"/></svg></div>
                    <span className="why-tile__label">Fully insured</span>
                    <span className="why-tile__desc">Contingent cargo and auto, general liability, E&amp;O, and cyber.</span>
                  </div>
                </div>
              </div>
            </div>
