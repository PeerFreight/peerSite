    ...
    <footer className="footer">
      ...
      <div className="wrap">
        <div className="footer__legal">
          <span>FMCSA broker authority active · USDOT 5766712 · $75K bonded (BMC-84) · TIA member · Licensed and insured</span>
          <span className="footer__links">
            <a href="https://www.ycombinator.com/" aria-label="Y Combinator"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3 3h18v18H3z" fill="none" stroke="currentColor" strokeWidth="1.5"/><path d="M11.5 13.5 8 7h1.9l2.1 4 2.1-4h1.9L12.5 13.5V17h-1z"/></svg></a>
