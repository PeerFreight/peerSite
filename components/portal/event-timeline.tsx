const EVENT_LABELS: Record<string, string> = {
  ...
  tracking_started: "Live tracking started",
  tracking_stopped: "Live tracking stopped",
  tracking_link_sent: "Tracking link emailed",
  tracking_link_revoked: "Tracking link revoked (internal)",
  tracking_status: "Tracking status update (internal)",
